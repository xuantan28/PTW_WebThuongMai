...
@section('title','E-SHOP || Trang thương hiệu')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{route('brand.destroy',[$brand->id])}}">
                          @csrf 
                          @method('delete')
                              <button class="btn btn-danger btn-sm dltBtn" data-id={{$brand->id}} style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" data-placement="bottom" title="Xoá"><i class="fas fa-trash-alt"></i></button>
                        </form>
                    </td>
                    {{-- Delete Modal --}}
        ...
        @else
          <h6 class="text-center">Không tìm thấy thương hiệu!!! Hãy tạo thêm thương hiệu</h6>
        @endif
      </div>
    </div>
</div>
