...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('coupon.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm Coupon</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{route('coupon.destroy',[$coupon->id])}}">
                          @csrf 
                          @method('delete')
                              <button class="btn btn-danger btn-sm dltBtn" data-id={{$coupon->id}} style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" data-placement="bottom" title="Xoá"><i class="fas fa-trash-alt"></i></button>
                        </form>
                    </td>
                    {{-- Delete Modal --}}
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="post" action="{{ route('banners.destroy',$user->id) }}">
                                @csrf 
                                @method('delete')
                                <button type="submit" class="btn btn-danger" style="margin:auto; text-align:center">Xoá vĩnh viễn nười dùng</button>
                              </form>
                            </div>
                          </div>
                        </div>
        ...
        @else
          <h6 class="text-center">Không tìm thấy Coupon!!! Hãy tạo thêm Coupon</h6>
        @endif
      </div>
    </div>
</div>
